...
# Configuration
app.config.update(
    SQLALCHEMY_DATABASE_URI=os.environ.get('DATABASE_URI', 'postgresql://culserv_9mkn_user:xRVXOpksM7SKWhV5n2F4c9wngxEufwUq@dpg-d1jvkrvdiees73ck063g-a/culserv_9mkn'),
